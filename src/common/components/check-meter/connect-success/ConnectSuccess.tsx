  ...
  return (
    <Grid container className={classes.container}>
      <Grid container alignItems='center'>
        ...
        <Grid item xs={9} sm={10} md={11} className={classes.title}>
              ...
              <Grid item className={classes.phaseBlock}>
                <div className={classes.phaseContainer}>
                  ...
                  <span className={classes.onePhasePowers}>
                    {
                      formatNumberES(parseFloat(reading.readings[0].readingsMeter.filter(item => item.readingTypeId === '421')[0].meterReadings[0].value))
                    }
                  </span>
                </div>
              </Grid>
                ...
                <Grid item>
                  <div className={classes.phaseContainer}>
                    ...
                    <span className={classes.triPhasePowers}>
                      {
                        formatNumberES(parseFloat(reading.readings[0].readingsMeter.filter(item => item.readingTypeId === '507')[0].meterReadings[0].value))
                      }
                    </span>
                  </div>
                </Grid>
              ...
              <Grid container direction='column' spacing={2}>
                ...
                <Grid item>
                  <div className={classes.phaseContainer}>
                    ...
                    <span className={classes.triPhasePowers}>
                      {
                        formatNumberES(parseFloat(reading.readings[0].readingsMeter.filter(item => item.readingTypeId === '515')[0].meterReadings[0].value))
                      }
                    </span>
                  </div>
                </Grid>
              ...
              <Grid container direction='column' spacing={2}>
                ...
                <Grid item>
                  <div className={classes.phaseContainer}>
                    ...
                    <span className={classes.triPhasePowers}>
                      {
                        formatNumberES(parseFloat(reading.readings[0].readingsMeter.filter(item => item.readingTypeId === '523')[0].meterReadings[0].value))
                      }
                    </span>
                  </div>
                </Grid>
