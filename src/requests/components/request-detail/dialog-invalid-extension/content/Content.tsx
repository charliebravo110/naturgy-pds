...
const Content = (props: any) => {
  ...
  const { 
    handleCloseDialog,
    extensions = 'DOC, DOCX, DXF, DWG, JPG, MPEG, MP4, MSG, PDF, PPT, PPTX, RAR, XLS, XLSM, XLSX y ZIP)'
  } = props
        ...
        <Grid>  
          ...
          <Grid container>
            ...
            <Grid container item xs={12} className={classes.gridTitle} justifyContent='center'>
              <span className={classes.spanTitle}>{t('requests.newRequestDetail.popupInvalidExtension.title')}</span>
            </Grid>
            <Grid container item xs={12} className={classes.gridText} justifyContent='center'>
              <span className={classes.spanSubtitle}>{t('requests.newRequestDetail.popupInvalidExtension.subtitle')}</span>
            </Grid>
            <Grid container item xs={12} className={classes.gridText} justifyContent='center'>
              <span className={classes.spanSubtitle}>{t('requests.newRequestDetail.popupInvalidExtension.extensions')+extensions}</span>
            </Grid>
          </Grid>
