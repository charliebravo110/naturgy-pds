...
const ListSupplies = (props: any) => {
	...
	const handleClick = (warning,index) => {
		//setSuplyyPoint(warning)
		//setCurrentPage(0)
		selectSupply(warning);
		setClickedRow(index)
			...
			<Table className={classes.suppliesTable}>
				<TableHead>
					<TableRow className={classes.tableRow}>
						<StyledTableCell className={classes.headTableCellCenter}>{t('averias.management.searchCups.table.nif')}
							<TableSortLabel
								active={showNifArrow}
						...
						<StyledTableCell className={classes.headTableCellCenter}>{t('averias.management.searchCups.table.name')}
							<TableSortLabel
						...
						<StyledTableCell className={classes.headTableCellCenter}>{t('averias.management.searchCups.table.cups')}
							<TableSortLabel
						...
						<StyledTableCell className={classes.headTableCellCenter}>{t('averias.management.searchCups.table.address')}
							<TableSortLabel
						...
						<StyledTableCell className={classes.headTableCellCenter}>{t('averias.management.searchCups.table.suministro')}
							<TableSortLabel
				...
				<TableBody>
					{
						(listItems?.length === 0 || listItems === undefined) ?
							...
							listItems?.slice(
								...
								(supply, index) => {const originalIndex = (currentPage * itemsPerPage) + index; return (
									<>
										<TableRow key={originalIndex} className={clickedRow === originalIndex ? classes.tableBodyRowColored : classes.tableBodyRow}>
											...
											<StyledTableCell rowSpan={1} className={classes.suppliesTableButtonCell}>
												{
													<div
														...
														onClick={() => handleClick(supply,originalIndex)}
													>
