      ...
      try {
        ...
        sendGAEvent({
          ...
          info: {
            ...
            error: e,
            reactComponent: 'new-provision/Location.tsx - useEffect',
            apiUrl: 'post /catastro',
    ...
    try {
      ...
      sendGAEvent({
        ...
        info: {
          error_message: (e as any).result ? (e as any).result.msgResult : ((e as any).msgResult ? (e as any).msgResult : 'Error al llamar al servicio'),
          error: e,
          reactComponent: 'new-provision/Location.tsx - checkIfHuso30',
          apiUrl: 'post /catastro',
          codResult: (e as any).result ? (e as any).result.codResult : ((e as any).codResult ? (e as any).codResult : '')
        }
      });
    ...
    try {
      ...
      sendGAEvent({
        ...
        info: {
          error_message: (e as any).result ? (e as any).result.msgResult : ((e as any).msgResult ? (e as any).msgResult : 'Error al llamar al servicio'),
          error: e,
          reactComponent: 'new-provision/Location.tsx - searchByCadastralReference',
          apiUrl: 'post /catastro',
          codResult: (e as any).result ? (e as any).result.codResult : ((e as any).codResult ? (e as any).codResult : '')
        }
      });
  ...
  return (
    <>
      ...
      />
        ...
        { // by-pass de la referencia catastral
          (
            provisions.dossierSubtype === 'DOSSUB001' || // grandes desarrollos
            provisions.dossierSubtype === 'DOSSUB003' || // uso industrial (varios suministros)
            provisions.dossierSubtype === 'DOSSUB007' || // uso público
            //ppm 1007821 - inicio
            provisions.dossierSubtype === 'DOSSUB029' || // Vehiculo electrico en vía pública
            //ppm 1007821 - fin
            provisions.dossierSubtype === 'DOSSUB008' || // uso comercial
            provisions.dossierSubtype === 'DOSSUB010' || // eventuales
            provisions.dossierSubtype === 'DOSSUB011' // suministro de obra
          ) &&
