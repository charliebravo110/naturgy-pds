...
const Steps = (props: any) => {
  ...
  useEffect (() => {
    if (!window.location.pathname.includes('/provisions/detail')) {
    ...
    <>
      <div className={classes.block}>
        ...
        <Grid container className={classes.container}>
          <Grid item xs={12} md={10} className={classes.maxWidthForBigScreens}>
              ...
              <Grid item md={11} sm={11} xs={12} justifyContent='center'>
                {
                  ...
                  (requestDataCompleted || (currentProvision.dossierCod !== '' && currentProvision.dossierStatusId === 'STATUS0001')) ?
                    <>
                      ...
                      <ExpansionPanel expanded={expandedPanel === 'panel6'} disabled={state < 8} onChange={handleChangeExpandedPanel('panel6')}>
                        <ExpansionPanelSummary
