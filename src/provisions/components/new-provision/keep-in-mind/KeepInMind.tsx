        ...
        <Grid item xs={11} md={10} className={classes.maxWidthForBigScreens}>
         <div className={classes.title}>{t('provisions.newProvision.keepInMind.title')}</div>
          ...
          <Grid container justifyContent='center' alignItems='center' className={classes.items}>
            ...
            <Grid item className={classes.item} lg='auto' md={12} sm={12} xs={12}><img src={DocumentIcon} alt='' /></Grid>
            ...
            {mobile && <span className={classes.step}>{'6. ' + steps[5]}</span>}
          </Grid>
          {
            !mobile &&
          ...
          <Grid container className={classes.buttons}>
            <Button
              ...
              onClick={() => {                
                ...
                props.history.push('/provisions/new-provision')
              }}
            />
            ...
            <Button
              ...
              onClick={() => {            
                ...
                props.history.push('/provisions/new-provision/steps')
              }}
            />
          </Grid>
        </Grid>
