...
const Form = (props: any) => {
  ...
  const string = timestamp + '.' + PAYMENT_GATEWAY_MERCHANT_ID + '.' + orderId + '.' + amount + '.' + PAYMENT_GATEWAY_CURRENCY
...
return (
  <>
    ...
    >
      ...
      <input type='hidden' name='HPP_CUSTOMER_EMAIL' value={userEmail} />
      <input type='hidden' name='HPP_CUSTOMER_PHONENUMBER_MOBILE' value={'34|' + userPhone}/>
      <input type='hidden' name='ACCOUNT' value={account} />
      <input type='hidden' name='COMMENT1' value={t('provisions.payment.comment1') + ' ' + dossierCode} />
      <input type='hidden' name='CUST_NUM' value={userDNI} />
      <input type='hidden' name='VAR_REF' value={dossierCode && dossierCode.replace('EXP', '')} />
      <input type='hidden' name='PROD_ID' value={dossierCode} />
