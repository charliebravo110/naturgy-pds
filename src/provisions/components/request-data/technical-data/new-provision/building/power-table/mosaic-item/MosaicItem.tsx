...
const MosaicItem = (props: any) => {
  ...
  const updateTotalRequestedPower = (requestPower: string, numberOfSupplies: string) => {
    if (requestPower !== '' && numberOfSupplies !== '') {
      ...
      setTotalRequestedPower(total.toString() + 'kW')
    }
  }
  ...
  const handlePowerRequestedMin = (index) => {
        ...
        if (/*index === i && */powerList && powerList[i]) {
          ...
          if (item.buildableArea !== '') {
            ...
            if (powerList[i].useType !== '' && powerList[i].useType === 'UTISUB009') {
              ...
              if (!isNaN(power)) {
                if (power < 3.68 * numberOfSupplies) {
                  check = true
              ...
              if (!isNaN(power)) {
                ...
                if (power1 > power2) {
                  if (powerW < power1) {
                    ...
                    msg = t('provisions.newProvision.requestData.supplyType.form.errors.minPower') + aux.replace('.', ',') + 'kW'
                    // if (index === i) {
                    //   setDialogText('La Potencia Solicitada de Locales y Oficinas no supera la potencia mínima calculada ' + power1 / 1000 + 'kW.')
                    //   setPopUp(true)
                    // }
                    return {
                      ...item, requestPower: { bool: check, msg: msg }
                  ...
                  if (powerW < power2) {
                    ...
                    msg = t('provisions.newProvision.requestData.supplyType.form.errors.minPower') + aux.replace('.', ',') + 'kW'
                    // if (index === i) {
                    //   setDialogText('La Potencia Solicitada de Locales y Oficinas no supera la potencia mínima calculada ' + power2 / 1000 + 'kW.')
                    //   setPopUp(true)
                    // }
                    return {
                      ...item, requestPower: { bool: check, msg: msg }
      ...
      powerListErrors.map((item, i) => {
        ...
        if (index === i && powerList && powerList[i]) {
          if (e.target.value === '' || e.target.value === '0') {
            check = true
            msg = t('provisions.newProvision.requestData.supplyType.form.errors.requiredAndNotZero')
          } else if (powerList[i].useType === 'UTISUB001' && powerList[i].requestPower < 5.75) {
            check = true
            msg = t('provisions.newProvision.requestData.supplyType.form.errors.min5')
          } else if (powerList[i].useType === 'UTISUB002' && powerList[i].requestPower < 9.2) {
            check = true
            msg = t('provisions.newProvision.requestData.supplyType.form.errors.min9')
          } else if ((powerList[i].useType === 'UTISUB009' || powerList[i].useType === 'UTISUB010') && powerList[i].requestPower < 3.45) {
            check = true
            msg = t('provisions.newProvision.requestData.supplyType.form.errors.min3-45')
          } else if (powerList[i].useType === 'UTISUB013' && powerList[i].requestPower < 3.45) {
            check = true
            msg = t('provisions.newProvision.requestData.supplyType.form.errors.min3-45')
          } else if ((powerList[i].applicationType === 'UTITYP001' || powerList[i].applicationType === 'UTITYP002') && powerList[i].requestPower > 99) {
            check = false
            setDialogText(t('provisions.newProvision.requestData.supplyType.form.errors.powerError'))
            setShowDialog(true)
          } else if ((powerList[i].applicationType === 'UTITYP003' || powerList[i].applicationType === 'UTITYP004') && powerList[i].requestPower > 999) {
            check = false
            setDialogText(t('provisions.newProvision.requestData.supplyType.form.errors.powerError'))
            setShowDialog(true)
          ...
          else if ((powerList[i].applicationType === 'UTITYP004')) { //UTITYP004
          ...
          else if ((powerList[i].applicationType === 'UTITYP003' && powerList[i].useType === 'UTISUB009')) { //UTITYP003 ventilación manual
            let powerW = powerList[i].requestPower * 1000
            let power2 = 3450 * powerList[i].numberOfSupplies // 3450
            let power1 = powerList[i].buildableArea * 10 // 10.000
            if (power1 > power2) {
              if (powerW < power1) {
                setDialogText('La Potencia Solicitada de garajes no supera la potencia mínima calculada ' + power1 / 1000 + 'kW.')
                setShowDialog(true)
              }
            } else {
              if (powerW < power2) {
                setDialogText('La Potencia Solicitada de garajes no supera la potencia mínima calculada ' + power2 / 1000 + 'kW.')
                setShowDialog(true)
              }
            }
          }

          else if ((powerList[i].applicationType === 'UTITYP003' && powerList[i].useType === 'UTISUB0010')) { //UTITYP003 ventilación forzada
            let powerW = powerList[i].requestPower * 1000
    ...
    <div key={index} className={classes.mobileRow}>
      <Grid container direction='column' className={classes.inputContainer}>
        <Grid item className={classes.label}>
          <Typography>{t('provisions.newProvision.requestData.supplyType.form.technicalInstallationData.building.table.tableHead.col1')}</Typography>
        </Grid>
        ...
        <Grid item className={classes.input}>
          {
            state === 0 ?
              <Select
                ...
                values={
                  ((provisions.selectedSupplyType === 'UR' && provisions.selectedSupplySubtype === 'DOSSUB006') || provisions.selectedSupplySubtype === 'DOSSUB005') ?
                    ...
                    (provisions.selectedSupplySubtype === 'DOSSUB031') ?
                      typesSelect.filter(i => !i.startsWith('UTITYP005') && !i.startsWith('UTITYP006'))
                      :
                      (provisions.selectedSupplySubtype === 'DOSSUB001') ?
                        typesSelect.filter(i => !i.startsWith('UTITYP002') && !i.startsWith('UTITYP003') && !i.startsWith('UTITYP006') && !i.startsWith('UTITYP007'))
                        :
                ...
                helperText={(powerListErrors[index] && powerListErrors[index].applicationType && powerListErrors[index].applicationType.bool) && powerListErrors[index].applicationType.msg}
              />
              :
      ...
      <Grid container direction='column' className={classes.inputContainer}>
        <Grid item className={classes.label}>
          <Typography>{t('provisions.newProvision.requestData.supplyType.form.technicalInstallationData.building.table.tableHead.col2')}</Typography>
        </Grid>
      ...
      <Grid container direction='column' className={classes.inputContainer}>
        <Grid item className={classes.label}>
          <Typography>{t('provisions.newProvision.requestData.supplyType.form.technicalInstallationData.building.table.tableHead.col3')}</Typography>
        </Grid>
        ...
        <Grid item className={classes.input}>
          {
            state === 0 ?
              <InputNumeric
                ...
                helperText={(powerListErrors[index] && powerListErrors[index].numberOfSupplies && powerListErrors[index].numberOfSupplies.bool) && powerListErrors[index].numberOfSupplies.msg}
              />
              :
      ...
      <Grid container direction='column' className={classes.inputContainer}>
        <Grid item className={classes.label}>
          <Typography>{t('provisions.newProvision.requestData.supplyType.form.technicalInstallationData.building.table.tableHead.col4')}</Typography>
        </Grid>
        ...
        <Grid item className={classes.input}>
          {
            state === 0 ?
              <Input
                ...
                helperText={(powerListErrors[index] && powerListErrors[index].buildableArea && powerListErrors[index].buildableArea.bool) && powerListErrors[index].buildableArea.msg}
      ...
      <Grid container direction='column' className={classes.inputContainer}>
        <Grid item className={classes.label}>
          <Typography>{t('provisions.newProvision.requestData.supplyType.form.technicalInstallationData.building.table.tableHead.col5')}</Typography>
        </Grid>
            ...
            state === 0 ?
              ...
              >
                <Input
                  ...
                  helperText={(powerListErrors[index] && powerListErrors[index].requestPower && powerListErrors[index].requestPower.bool) && powerListErrors[index].requestPower.msg}
                  InputProps={{
