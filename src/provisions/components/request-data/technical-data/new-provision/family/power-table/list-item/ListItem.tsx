...
const ListItem = (props: any) => {
  ...
  return (
    ...
    <TableRow key={index} className={classes.row}>
      <StyledTableCell>
        <div className={classes.inputTableFirst}>
          {
            // provisions.selectedSupplySubtype === 'DOSSUB004' ?
            //   state === 0 ?
            //     <Input
            //       fullWidth
            //       value={typesSelect.filter(item => item.split('|')[0] === 'UTITYP001').map(item => item.split('|')[1])[0]}
            //       disabled
            //     />
            //     :
            //     <Typography className={classes.stateLabel}>
            //       {typesSelect.filter(item => item.split('|')[0] === 'UTITYP001').map(item => item.split('|')[1])[0]}
            //     </Typography>
            ...
            state === 0 ?
              <Select
                ...
                values={
                  provisions.selectedSupplySubtype === 'DOSSUB004' ?
                    typesSelect.filter(i => i.startsWith('UTITYP001'))
                    :
                    typesSelect
                }
                codFiltering
                ...
                disabled={provisions.selectedSupplySubtype === 'DOSSUB004'}
              />
              :
