...
const Form = (props: any) => {
  ...
  const [idDossierStructureSchema, setIdDossierStructureSchema] = useState()
  ...
  useEffect(() => {
    setPowerListErrors(powerListErrors.map((item, i) => {
      let check
      let msg
      if (powerList && powerList[i] && powerList[i].requestPower !== '') {
        if (techData.electricVehicleCharging === '1' && powerList[i].requestPower < 9.2) {
          check = true
          msg = t('provisions.newProvision.requestData.supplyType.form.errors.min9')
        } else if (parseInt(powerList[i].buildableArea) > 160 && powerList[i].requestPower < 9.2) {
          check = true
          msg = t('provisions.newProvision.requestData.supplyType.form.errors.min9')
        } else if ((techData.idDossierAircondType === 'AIRCOD_PRE' || techData.idDossierAircondType === 'AIRCOD_INS') && powerList[i].requestPower < 9.2) {
          check = true
          msg = t('provisions.newProvision.requestData.supplyType.form.errors.min9')
        } else if (techData.idDossierHeatingType === 'HEATSYS001' && powerList[i].requestPower < 9.2) {
          check = true
          msg = t('provisions.newProvision.requestData.supplyType.form.errors.min9')
        ...
        } else if (powerList[i].requestPower > 50) {
          check = false
          msg = t('provisions.newProvision.requestData.supplyType.form.errors.powerHigh')
        } else {
          check = false
        }
    ...
    // eslint-disable-next-line
  }, [techData.electricVehicleCharging, powerList, techData.idDossierAircondType, techData.idDossierHeatingType, techData.phase])
  ...
  // Si los 2 campos de comentarios son diferentes, mostrar la concatenacion de ambos
  ...
  return (
    <>
      <Grid container direction='column' md={5}>
        <Grid container direction='column' className={classes.inputContainer}>
          <Grid item className={classes.label}>
            <Typography>{t('provisions.newProvision.requestData.supplyType.form.technicalInstallationData.family.firstColumn.input1')}</Typography>
          </Grid>
          ...
          <Grid item className={classes.input}>
            {state === 0 ?
              <Select
                fullWidth
                label={t('provisions.newProvision.requestData.supplyType.form.technicalInstallationData.family.selectLabel.voltageSupply')}
        ...
        <Grid container direction='column' className={classes.inputContainer}>
          <Grid item className={classes.label}>
            <Typography>{t('provisions.newProvision.requestData.supplyType.form.technicalInstallationData.family.firstColumn.input2')}</Typography>
          </Grid>
          ...
          <Grid item className={classes.input}>
            {state === 0 ?
              <Select
                fullWidth
                codFiltering
                label={t('provisions.newProvision.requestData.supplyType.form.technicalInstallationData.family.selectLabel.default')}
      ...
      <Grid container direction='column' md={5}>
        <Grid container direction='column' className={classes.inputContainer}>
          <Grid item className={classes.label}>
            <Typography>{t('provisions.newProvision.requestData.supplyType.form.technicalInstallationData.family.secondColumn.input1')}</Typography>
          </Grid>
          ...
          <Grid item className={classes.input}>
            {state === 0 ?
              <Select
                fullWidth
                label={t('provisions.newProvision.requestData.supplyType.form.technicalInstallationData.family.selectLabel.numberOfPhases')}
        ...
        <Grid container direction='column' className={classes.inputContainer}>
          <Grid item className={classes.label}>
            <Typography>{t('provisions.newProvision.requestData.supplyType.form.technicalInstallationData.family.secondColumn.input3')}</Typography>
          </Grid>
        ...
        {provisions.selectedSupplySubtype === 'DOSSUB005' &&
          <Grid container direction='column' className={classes.inputContainer}>
            <Grid item className={classes.label}>
              <Typography>{t('provisions.newProvision.requestData.supplyType.form.technicalInstallationData.family.secondColumn.input4')}</Typography>
            </Grid>

            <Grid item className={classes.input}>
              <div className={classes.marginLeft}>
                <Switch
                  onChange={handleExistingAco}
                  checked={techData.existingAco === '0'}
                  disabled={state !== 0}
                />
              </div>
            </Grid>
      ...
      <Grid container direction='column' className={classes.inputBlock}>
        ...
        {state === 0 ?
          ...
          :
          <Grid item className={classes.stateLabel}>
            <Typography>
