    ...
    <>
      <Grid container className={`${classes.container} ${!openView ? 'border' : ''}`}>
        <Grid container>
          ...
          <Grid container md={11} sm={11} xs={11} direction='column'>
            <Grid item>
              <Grid container justifyContent='space-between'>
                ...
                <Grid item>
                  {openView ? (
                    <ExpandLessIcon onClick={handleOpenView} className={classes.expandIcon} />
                  ) : (
                    <ExpandMoreIcon onClick={handleOpenView} className={classes.expandIcon} />
                  )}
                </Grid>
              </Grid>
            </Grid>
              ...
              <Grid container alignItems='center'>
...

                {
                  (attachment && attachment !== '') &&
                    <Grid item className={classes.responseLink}>
