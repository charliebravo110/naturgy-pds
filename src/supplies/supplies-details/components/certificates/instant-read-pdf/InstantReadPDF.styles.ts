...
const useStyles = StyleSheet.create({
  ...
  contractInvoicesTableHeaderRowCell100: {
    width: '100%',
    padding: 4
  },
  ...
  contractInvoicesTableHeaderRowCell10: {
    width: '10%',
    padding: 4
  },
  ...
  contractInvoicesTableContainerRowCell10: {
    width: '10%',
    padding: 4
  },
  contractInvoicesTableContainerRowCell10Colored: {
    width: '10%',
    backgroundColor: '#FCF1E5',
    padding: 4
  },
