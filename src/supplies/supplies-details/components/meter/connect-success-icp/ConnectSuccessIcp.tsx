                ...
                <Grid item>
                  <div className={classes.phaseContainer}>
                    ...
                    <span className={classes.triPhasePowers}>
                      {
                        handleReading(reading.readings[0].readingsMeter.filter(item => item.readingTypeId === '507')[0].meterReadings[0].value) 
                      }
                    </span>
                  </div>
                </Grid>
              ...
              <Grid container direction='column' spacing={2}>
                ...
                <Grid item>
                  <div className={classes.phaseContainer}>
                    ...
                    <span className={classes.triPhasePowers}>
                      {
                        handleReading(reading.readings[0].readingsMeter.filter(item => item.readingTypeId === '515')[0].meterReadings[0].value) 
                      }
                    </span>
                  </div>
                </Grid>
              ...
              <Grid container direction='column' spacing={2}>
                ...
                <Grid item>
                  <div className={classes.phaseContainer}>
                    ...
                    <span className={classes.triPhasePowers}>
                      {
                        handleReading(reading.readings[0].readingsMeter.filter(item => item.readingTypeId === '523')[0].meterReadings[0].value) 
                      }
                    </span>
                  </div>
                </Grid>
