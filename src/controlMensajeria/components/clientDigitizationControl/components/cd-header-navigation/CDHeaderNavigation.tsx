...
import useStyles from './CDHeaderNavigation.styles'

const CDHeaderNavigation = (props: any) => {
      ...
      >
        {
          <StyledTab
            ...
            label={t('clientDigitizationControl.navigation.detail')}
            icon={
              (tabletRes || mobileRes) &&
...

        {
          <StyledTab
            className={(tabletRes || mobileRes) ? classes.tabMobile : classes.tab}
            label={t('clientDigitizationControl.navigation.graph')}
            icon={
              (tabletRes || mobileRes) &&
              <img src={ArrowRightIcon} alt='' />
            }
...
export default withRouter(CDHeaderNavigation)
